...
- **Documented**: 101 (41 builtins + 60 stdlib)
- **Coverage**: 30.0%
...
### ✅ Async & Concurrency (7/11 documented)

Core async/concurrency modules documented:
- ✅ `asyncio` - Asynchronous I/O (already documented)
- ✅ `concurrent.futures` - Executor-based parallelism
- ✅ `contextvars` - Context variables for async
- ✅ `multiprocessing` - Process-based parallelism
- ✅ `selectors` - Multiplexed I/O
- ✅ `threading` - Thread-based parallelism (already documented)
- ✅ `queue` - Thread-safe queues (already documented)

Remaining:
- [ ] `signal` - Signal handling
- [ ] `asynchat` - Async chat utilities (deprecated)
- [ ] `asyncore` - Async socket dispatcher (deprecated)
- [ ] `concurrent.futures.ProcessPoolExecutor` details
